...
es_1000 = df_list(glob.glob('./es_1000*.csv'), 'es, n=1000')
es_1500 = df_list(glob.glob('./es_1500*.csv'), 'es, n=1500')
es_2000 = df_list(glob.glob('./es_2000*.csv'), 'es, n=2000')
...
df['sample'] *= [1000 if alg=='es, n=1000' else 1 for alg in df['algorithm']]
df['sample'] *= [1500 if alg=='es, n=1500' else 1 for alg in df['algorithm']]
df['sample'] *= [2000 if alg=='es, n=2000' else 1 for alg in df['algorithm']]
